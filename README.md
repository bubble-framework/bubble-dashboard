...
- To run this app on its own, you may run `npm run dashboard` from the `server` directory, and view it in your browser at [http://localhost:3000](http://localhost:3000).
